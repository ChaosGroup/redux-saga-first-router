...
var _marked = [onNavigate, routeSaga, historyToStore, storeToHistory, saga].map(_regenerator2.default.mark);
		...
		while (1) {
			switch (_context5.prev = _context5.next) {
				...
				case 2:
					...
					_context5.next = 5;
					return (0, _effects.all)([(0, _effects.call)(routeSaga, routesMap), (0, _effects.call)(historyToStore, routesMap, historyChannel), (0, _effects.call)(storeToHistory, routesMap, history)]);
